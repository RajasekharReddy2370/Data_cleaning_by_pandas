...
for folder in all_folders:
    ...
    if folder == 'Sangareddy_39':
        ...
        for file in all_files_in_folder:
            ...
            #
                        selected_columns = [col for col in df.columns if
                                            col in PhoneNumbers or col in beneficiary_names or col in gender]
          ...
          # if file.endswith('.csv') or 'Arogya Laxmi' in file:
            #     # Your code for processing CSV files or files containing 'Arogya Laxmi' in the filename
            # if file.endswith('.csv') or 'Arogya Laxmi' in file:
            #
                # try:
            ...
            #             print(filtered_df)
            # if file.endswith('.csv') and 'Laxmi' in file or 'Shadi' in file:
            ...
            # if file.endswith('.csv')  ('Arogya Laxmi' in file):
                ...
                try:
                    ...
                    print(filtered_df.columns)
                    if len(filtered_df.columns) in [2, 3]:
        ...
        # result_df.to_excel(f'/home/rajashekar/Desktop/ThursDay_Meh_Med/Medak/Medak_Beneficiary_Females/{constituency_name}_Male_Data.xlsx',index=False)
        result_df.to_excel(f'/home/rajashekar/Desktop/ThursDay_Meh_Med/Medak/Medak_Beneficiary_Females/{constituency_name}_Female_Data.xlsx',index=False)
