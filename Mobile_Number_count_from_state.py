...
main_folder_path = r"/home/rajashekar/Desktop/All_states_data/Name_and_Mobile_Number/t"
...
for file in files:
    ...
    df = df[['Names','Mobile']]
    df.to_excel(f"/home/rajashekar/Desktop/All_states_data/Name_and_Mobile_Number/t/{constituency}_Names_and_Mobile.xlsx", index=False)
    ...
    # C = len(df_mobile)
    # df_mobile.to_excel(f"/home/rajashekar/Desktop/All_states_data/one_drive_data/M_P/{constituency}_Mobile.xlsx", index=False)
