...
df = pd.read_excel(r"/home/rajashekar/WORK/voters_prac/GUNTUR_WEST_85A_PWD_DATA.xlsx")
...
'''
            ...
            generate_pdf(f'/home/rajashekar/Documents/85+_PWD/{row["B#"]}_{row["Names"]}.pdf', form_text)
            # break
