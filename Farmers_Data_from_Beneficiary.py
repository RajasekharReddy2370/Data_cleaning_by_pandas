...
for folder in all_folders:
    ...
    if folder == 'Siddipet_33':
        ...
        for file in all_files_in_folder:
            ...
            # if file.endswith('.csv') and ('Asra' in file or 'Rytu' in file or 'Kantivelegu' in file or 'Rythubhima' in file or 'Dalit' in file or 'Milk' in file or 'Tractor' in file or 'Sheep' in file or 'Procurement' in file):
            if file.endswith('.csv') and ('Rytu' in file or 'Rythubhima' in file or 'Tractor' in file):
        ...
        print(result_df)
        result_df.to_excel(f'/home/rajashekar/Desktop/ThursDay_Meh_Med/Medak/Medak_Farmers_Updated/{constituency_name}_Farmers_Mobile_Numbers.xlsx',index=False)
