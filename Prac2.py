        ...
        for file in all_files_in_folder:
            ...
            if file.endswith('.xlsx'):
                for i in range(0,4):
                    ...
                    if all(col in df.columns for col in beneficiary_names) and all(
                            col in df.columns for col in PhoneNumbers):
...
#                 #
#                 # df.to_excel(f'/home/rajashekar/Desktop/M_B_S_C/Siddipet_Schemes/With_Mobile_Numbers/{fil}_cleaned.xlsx',
#                 #             index=False)
...
#
#                     df.to_excel(
#                         f'/home/rajashekar/Desktop/M_B_S_C/Siddipet_Schemes/With_Mobile_Numbers/{fil}_cleaned.xlsx',
#                         index=False)
#                     df.to_excel(f'/home/rajashekar/Desktop/M_B_S_C/Siddipet_Schemes/{fil}_cleaned.xlsx', index=False)
#                 else:
#
...
#                     df.to_excel(
#                         f'/home/rajashekar/Desktop/M_B_S_C/Siddipet_Schemes/Without_Mobile_Numbers/{fil}_cleaned.xlsx',
#                         index=False)
#                     df.to_excel(f'/home/rajashekar/Desktop/M_B_S_C/Siddipet_Schemes/{fil}_cleaned.xlsx', index=False)
#
# end_time = time.time()
